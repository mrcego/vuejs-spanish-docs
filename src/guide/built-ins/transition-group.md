...
:::tip
Cuando se utiliza en [plantillas en el DOM](/guide/essentials/component-basics#in-dom-template-parsing-caveats), se debe hacer referencia a este como `<transition-group>`.
:::
