...
Ten en cuenta que la expresión está sujeta a las [restricciones sintácticas](/guide/essentials/template-syntax#dynamic-argument-syntax-constraints) de los argumentos de la directiva dinámica.
